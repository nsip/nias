	...
	recordid = 0
		...
		if(fromcsv)
			...
			msg = e + "\n" + payload
                ...
                outbound_messages << Poseidon::MessageToSend.new( @outbound, NiasError.new(i, errors.length, recordid, "SRM Unique Identity Check", msg).to_s, "rcvd:#{ sprintf('%09d:%d', m.offset, i)}" ) 
            end
