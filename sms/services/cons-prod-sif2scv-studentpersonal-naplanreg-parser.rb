...
loop do
  ...
  begin
		...
		#header = m.value.lines[0]
			...
			csv['Previous Local School Student ID'] = lookup_xpath(nodes, "//OtherIdList/OtherId[@Type = 'PreviousLocalSchoolStudentId']")
			...
			csv['Previous Jurisdiction Student ID'] = lookup_xpath(nodes, "//OtherIdList/OtherId[@Type = 'PreviousStateProvinceId']")
			...
			csv['Local Campus ID'] = lookup_xpath(nodes, "//MostRecent/LocalCampusId")
			csv['Main School Flag'] = lookup_xpath(nodes, "//MostRecent/MembershipType")
			csv['Other School ID'] = lookup_xpath(nodes, "//MostRecent/OtherEnrollmentSchoolACARAId")
			csv['Reporting School ID'] = lookup_xpath(nodes, "//MostRecent/ReportingSchoolId")
			...
			csv['Parent 1 School Education'] = lookup_xpath(nodes, "//MostRecent/Parent1SchoolEducationLevel")
			csv['Parent 1 Non-School Education'] = lookup_xpath(nodes, "//MostRecent/Parent1NonSchoolEducation")
			csv['Parent 1 Occupation'] = lookup_xpath(nodes, "//MostRecent/Parent1EmploymentType")
			csv['Parent 1 Main Language Other than English Spoken at Home'] = lookup_xpath(nodes, "//MostRecent/Parent1Language")
			csv['Parent 2 School Education'] = lookup_xpath(nodes, "//MostRecent/Parent2SchoolEducationLevel")
			csv['Parent 2 Non-School Education'] = lookup_xpath(nodes, "//MostRecent/Parent2NonSchoolEducation")
			csv['Parent 2 Occupation'] = lookup_xpath(nodes, "//MostRecent/Parent2EmploymentType")
